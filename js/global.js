     ...
     <table border=0 style="width:100%">
        <tr><!--title-->
            <td style="text-align:right;width:1%;">
                <img  alt="Loading" data-id="${nft_id}" data-price="${adjective[0]}" class="lazy" data-src="https://www.gravatar.com/avatar/${sha256('billboards'+nft_id).toLowerCase().slice(-32)}?s=60&r=g&d=identicon" style="width:60px;height:60px" /> 
            </td>
